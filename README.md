...
The following are a few of the questions that are answered in the project (check out <a href="https://github.com/Gourav255/MUsic-store-analysis-GOURAV/blob/main/analysis.sql">analysis.sql</a> file for the rest):
